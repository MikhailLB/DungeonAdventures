...
/// Persistence layer for the hub flow.
/// Non-sensitive flags → SharedPreferences. Sensitive (URLs, tokens) → SecureStorage.
class DungeonVault {
  // SharedPreferences keys — unique dga.* prefix
  static const _kMode         = 'dga.hub.mode';
  static const _kPushCooldown = 'dga.hub.push.cooldown';
  static const _kPushConsent  = 'dga.hub.push.consent';
  // SecureStorage keys
  static const _kSavedUrl    = 'dga.hub.url';
  static const _kUrlTtl      = 'dga.hub.url.ttl';
  static const _kOneShotUrl  = 'dga.hub.push.oneshot';
  ...
  RouteMode readMode() => RouteMode.fromKey(_prefs.getString(_kMode));

  Future<void> writeMode(RouteMode m) async =>
